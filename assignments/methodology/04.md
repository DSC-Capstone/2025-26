...
Before attempting this assignment, make sure to read [Lesson 6](https://dsc-capstone.org/2024-25/lessons/06). Submit this assignment by **Monday, November 3rd at 11:59PM**. Post questions with the assignment on Piazza.
...
1. Edit `README.md` so that, underneath the line with `# DSC180A-Methodology`, there's a single line of text with their full name.
